...
export default function CheckoutPage() {
    ...
    function handleSubmit(e) {
        ...
        if (formData.cardNumber !== "" &&
            ...
            formData.CVV) {
            const promise = axios.post('http://localhost:5000/orders', formData, {
                headers: {
                    'authorization': `Bearer ${token}`
                }
            });
                ...
                <CentralizedDiv>
                    <CheckoutForm>
                        {formStage === 'adress' ?
                            <>
                                ...
                                <button onClick={continueButton} type="button" className="continue-button">Continuar</button>
                            </> :
                        ...
                        {formStage === 'payment' ?
                            <>
                                ...
                                <button onClick={e => handleSubmit(e)} className="continue-button">Pagar</button>
                            </> :
                    ...
                    <ProductInfo>
                        ...
                        {productsInfo.map(product => {
                            return (
                                <div className="product-div" key={productsInfo.indexOf(product)}>
